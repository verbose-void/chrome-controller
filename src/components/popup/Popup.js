		...
		<div className='popup__container'>
			...
			<div id='title' className='mainContent__container text-center'>
				...
				<div className='tabs__container'>
					<Tabs id='generalButtonMappingTabs' defaultActiveKey='general'>
						<Tab eventKey='general' title='General'>
							<GeneralTab state={state.generalTab} dispatch={dispatch} />
						</Tab>
						<Tab eventKey='buttonMapping' title='Button Mapping'>
							<MappingTab state={state.mappingTab} dispatch={dispatch} />
						</Tab>
					</Tabs>
				</div>
			</div>
