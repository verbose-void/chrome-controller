...
const defaultParams = [null, handleRuntimeError];
...
export const tabLeft = () => {
	chrome.tabs.query({}, tabs => {
		...
		let tabToLeftOfActive = activeTab === 0 ? tabs.length - 1 : activeTab - 1;
...
export const tabRight = () => {
	chrome.tabs.query({}, tabs => {
		...
		let tabToRightOfActive = activeTab === tabs.length - 1 ? 0 : activeTab + 1;
